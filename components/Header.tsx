...
function Header() {
  ...
  return (
    <header className="bg-[#013B94]">
      <nav
        className="flex items-center justify-between max-w-7xl p-6 lg:p-8 mx-auto"
        aria-label="Global"
      >
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            ...
            {/* <img
              ...
              alt="Logo"
            /> */}
            <h1 className="h-12 w-auto text-white font-bold text-xl lg:text-2xl">
              Grove-St.
            </h1>
          </Link>
        </div>
        ...
        <div className="flex lg:hidden">
          <button
            type="button"
            className="-m-2.5 inline-flex justify-center items-center rounded-md p-2.5 text-white"
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            ...
            >
              <Popover.Panel className="absolute bg-white -left-8 top-full mt-3 z-100 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/50">
                <div className="p-4">
                  {product.map((item) => (
                    <div
                      key={item.name}
                      className="group relative flex items-center gap-x-4 p-4 rounded-lg text-sm leading-6 hover:bg-gray-50"
                    >
          ...
          <div className="flex items-center justify-between">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              {/* <img
                ...
                alt="Logo"
              /> */}
              <h1 className="h-8 w-auto text-white font-bold text-md lg:text-lg">
              Menu
            </h1>
            </a>
            <button
